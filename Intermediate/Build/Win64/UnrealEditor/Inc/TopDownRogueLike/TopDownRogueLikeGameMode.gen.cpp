...
// End Cross Module References
...
#endif
		static const UECodeGen_Private::FUnsizedIntPropertyParams NewProp_Difficulty;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_TimeBetweenDifficultyIncreases_MetaData[];
#endif
		static const UECodeGen_Private::FUnsizedIntPropertyParams NewProp_TimeBetweenDifficultyIncreases;
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ATopDownRogueLikeGameMode_Statics::NewProp_Difficulty_MetaData[] = {
		{ "Category", "TopDownRogueLikeGameMode" },
		{ "ModuleRelativePath", "TopDownRogueLikeGameMode.h" },
	};
#endif
	const UECodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UClass_ATopDownRogueLikeGameMode_Statics::NewProp_Difficulty = { "Difficulty", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ATopDownRogueLikeGameMode, Difficulty), METADATA_PARAMS(Z_Construct_UClass_ATopDownRogueLikeGameMode_Statics::NewProp_Difficulty_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ATopDownRogueLikeGameMode_Statics::NewProp_Difficulty_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ATopDownRogueLikeGameMode_Statics::NewProp_TimeBetweenDifficultyIncreases_MetaData[] = {
		{ "Category", "TopDownRogueLikeGameMode" },
		{ "ModuleRelativePath", "TopDownRogueLikeGameMode.h" },
	};
#endif
	const UECodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UClass_ATopDownRogueLikeGameMode_Statics::NewProp_TimeBetweenDifficultyIncreases = { "TimeBetweenDifficultyIncreases", nullptr, (EPropertyFlags)0x0020080000010005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ATopDownRogueLikeGameMode, TimeBetweenDifficultyIncreases), METADATA_PARAMS(Z_Construct_UClass_ATopDownRogueLikeGameMode_Statics::NewProp_TimeBetweenDifficultyIncreases_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ATopDownRogueLikeGameMode_Statics::NewProp_TimeBetweenDifficultyIncreases_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ATopDownRogueLikeGameMode_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATopDownRogueLikeGameMode_Statics::NewProp_Difficulty,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATopDownRogueLikeGameMode_Statics::NewProp_Score,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATopDownRogueLikeGameMode_Statics::NewProp_TimeBetweenDifficultyIncreases,
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TopDownRogueLike_Source_TopDownRogueLike_TopDownRogueLikeGameMode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ATopDownRogueLikeGameMode, ATopDownRogueLikeGameMode::StaticClass, TEXT("ATopDownRogueLikeGameMode"), &Z_Registration_Info_UClass_ATopDownRogueLikeGameMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATopDownRogueLikeGameMode), 3974751634U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TopDownRogueLike_Source_TopDownRogueLike_TopDownRogueLikeGameMode_h_2600413801(TEXT("/Script/TopDownRogueLike"),
